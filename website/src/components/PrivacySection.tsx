      ...
      <div className="mx-auto max-w-6xl px-5 py-20">
        <div className="card-surface grid gap-8 p-8 md:grid-cols-[1.2fr_1fr] md:p-10">
          ...
          <ul className="space-y-3 text-sm text-muted">
            <li className="rounded-[4px] border border-border/80 px-4 py-3">No usage telemetry</li>
            <li className="rounded-[4px] border border-border/80 px-4 py-3">No central account system</li>
