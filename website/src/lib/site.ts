...
export const PRODUCT_FEATURES: ProductFeature[] = [
  ...
  },
  {
    id: 'reorder',
    kicker: 'Rank',
    title: 'Drag the chains and RPCs you actually use',
    hook: 'The Assets dropdown follows this order. Open a chain and drag endpoints — top of the list is preferred. Add a custom chain when the catalog is missing yours.',
    tryIt: 'Settings → Networks. Drag a chain to the top, then open it and rank the RPC.',
    shots: [
      {
        src: '/screenshots/features/networks-rank.png',
        width: 494,
        height: 674,
        caption: 'Mainnets and testnets, drag handle on the left. Active stays marked. This ranking is the dropdown.',
        alt: 'Networks list with drag handles, Ethereum active, and chains ranked Ethereum, Robinhood Chain, Base, HyperEVM',
      },
      {
        src: '/screenshots/features/rpc-rank.png',
        width: 505,
        height: 747,
        caption: 'Per-chain RPC list. Drag to rank. Top is preferred. Add your own URL at the bottom.',
        alt: 'HyperEVM RPC endpoints with drag handles and a Preferred badge on PublicNode',
      },
    ],
  },
  {
  ...
  },
  {
    id: 'ens',
    kicker: 'ENS',
    title: 'Register a .eth. Then run it.',
    hook: 'Commit → wait 60s → register, the standard controller flow. Confirm mode reviews each mainnet tx. Then content hash, URL text, renew. Names come from the ENS subgraph — optional Graph key if the public one flakes.',
    tryIt: 'Tools → ENS. Commit a name, or open one you already own.',
    shots: [
      {
        src: '/screenshots/features/ens-register.png',
        width: 503,
        height: 342,
        caption: 'Type the label, Commit, wait, register. Refreshing the wallet restarts an in-progress commit.',
      ...
      },
      {
        ...
        width: 479,
        height: 589,
        caption: 'Your names, expiry, IPFS/bzz content hash, URL text record, extend one year. On-chain writes go through the confirm sheet.',
  ...
  },
  {
    id: 'accounts',
    kicker: 'Accounts',
    title: 'Passport on the row. Double-click to copy.',
    hook: 'Human Passport is onchain — Human 22 on the account, no API key. Click a row to switch. Double-click the address to copy it. Seed, Trezor, Ledger, and a key in one list. Hardware still confirms on the device.',
    tryIt: 'Open the account menu. Double-click a row. Check the Human badge on a scored address.',
    shots: [
      {
        src: '/screenshots/features/accounts-passport.png',
        width: 500,
        height: 339,
        caption: 'Click to switch. Human Passport badge on the scored account. Burner, vault, Trezor, Ledger, imported key.',
        alt: 'Account switcher with a Human 22 Passport badge on Swarm and a tooltip to double-click the address to copy',
      },
      {
        src: '/screenshots/features/accounts-copy.png',
        width: 514,
        height: 361,
        caption: 'Double-click any account address — Copied! — then paste it. No extra Copy button hunt.',
